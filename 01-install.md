...
>> I use Python 2.7, I prefer the syntax and I am familiar with this version of Python. 

###Q2. Which Python Version Installed   

How can you check the version of Python installed if you happen to be on an unfamiliar computer?

>> On the command line, type python --version, 2.7.11 appears (depends on your version of Python)
